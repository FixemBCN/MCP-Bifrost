...
cd MCP-Bifrost
python3 -m unittest discover tests    # 177 tests, ~23s
...
both environments on every push. `git` guards 49 tests the same way.
...
| `tests/` | 177 tests — 53 need `php`, 49 need `git`, skipped when absent |
